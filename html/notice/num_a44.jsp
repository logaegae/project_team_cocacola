...
<div class="table_position">	
	<div class="wrap_table">
		<table id="board">
			...
			<tbody>
				<tr>
					<td class="subject">회원정보&nbsp;도로명&nbsp;주소&nbsp;반영</td>
				...
				<tr>
					<td colspan="2">
						...
						2014년 8월 1일 회원정보의 주소입력 시 기존 “지번 주소”와 “도로명 주소”로 입력이 가능하도록 업데이트 되었습
						니다.<br>
						안전행정부에서 2014년 부터 시행하고 있는 사항으로 회원의 주소정보를 변경 시 선택하여 입력이 가능하오니 많
						은 이용 바랍니다.<br><br>
						감사합니다.<br>
