...
<style type="text/css">
    ...
    .tvcf_submenu_option {background:url("../../lib/images/bg_brandSort_option.png") no-repeat 100% 100% }
    .video_tit {color:#ffc925;}
...
<div>
<%@include file="./videoC1_10.jsp"%>
</div>

<div>
<%@include file="./vidcate10.jsp"%>
</div>	
